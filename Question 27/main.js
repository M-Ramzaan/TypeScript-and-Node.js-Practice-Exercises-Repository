...
console.log(`27.	Alien Colors #3: Turn your if-else chain from Exercise 5-4 into an if-else chain.
...
//Alien Colors #3
{
    ...
    if (alienColor01 === "green") {
        console.log("Congratulations! You earned 05 points for shooting the alien.");
    }
