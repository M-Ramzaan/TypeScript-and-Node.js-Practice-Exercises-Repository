...
//Tests for equality and inequality with strings
let string1: string = "Muhammad Ramzan";
let string2: string = "Akram";
...
console.log(
  "Lowercase test:",
  upperCaseString.toLowerCase() === lowerCaseString.toLowerCase()
); // True
...
console.log(
  "Greater than and equal to test, Number 1 >= Number 2 = ",
  num1 >= num2
); //false
console.log(
  "Less than and equal to test, Number 1 <= Number 2 = ",
  num1 <= num2
); //true
